...
#    "2018" : "results/limits/2018_unblinded_3Jul24_sferr0p5/pnmd2prong/ipt1,0_irho1,0",
    "2016APV" : "/eos/home-j/jeffkrup/fitting/CMSSW_11_3_4/src/HiggsAnalysis/CombinedLimit/zprimeqq/results/limits/2016APV_9Jul24_v1/pnmd2prong/ipt2,0_irho2,0/",
    "2016" : "/eos/home-j/jeffkrup/fitting/CMSSW_11_3_4/src/HiggsAnalysis/CombinedLimit/zprimeqq/results/limits/2016_9Jul24_v1/pnmd2prong/ipt2,2_irho2,2/",
    "2017" : "/eos/home-j/jeffkrup/fitting/CMSSW_11_3_4/src/HiggsAnalysis/CombinedLimit/zprimeqq/results/limits/2017_9Jul24_v1/pnmd2prong/ipt2,1_irho3,0/",
    "2018" : "/eos/home-j/jeffkrup/fitting/CMSSW_11_3_4/src/HiggsAnalysis/CombinedLimit/zprimeqq/results/limits/2018_9Jul24_v1/pnmd2prong/ipt1,0_irho1,0/",
}
...
def combine():
    ...
    for era in args.eras:
        ...
        path_to_mass = f"{paths[era]}/m{args.mass}/m{args.mass}_model/"
    ...
    master_str += """\ntext2workspace.py -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel  --PO verbose --PO 'map=.*/*m{sigmass}:r[1,-5,5]'  --PO 'map=.*/*b{sigmass}:r[1,-5,5]' --PO 'map=.*/*p{sigmass}:r_p[1,-5,5]' {opath}/m{sigmass}/m{sigmass}_model/model_combined.txt""".format(sigmass=args.mass,opath=opath)
